...
class PostUpdateViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.username = 'jack'
        self.password = '123'
        user = User.objects.create_user(username=self.username, email='jack@word.site', password=self.password)
...
# 测试检查该视图是否使⽤了 @login_required 装饰器 （检查是否只有经过身份验证的⽤户访问编辑⻚⾯
...
# 是创建⼀个新⽤户 (检查本应⽤程序应该只能授权该⽂章的所有者进⾏编辑
